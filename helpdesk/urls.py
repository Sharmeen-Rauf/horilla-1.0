...
urlpatterns = [
    ...
    path("helpdesk/ai-assistant/", views.ai_assistant_view, name="helpdesk-ai-assistant"),
    path("helpdesk/ai-assistant-chat/", views.ai_assistant_chat, name="helpdesk-ai-assistant-chat"),
]
