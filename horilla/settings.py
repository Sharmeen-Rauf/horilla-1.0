...
env = environ.Env(
    ...
    SECRET_KEY=(
        str,
        "django-insecure-REDACTED-SECRET-KEY",
    ),
...
# Ollama AI (Helpdesk chatbot)
OLLAMA_MODEL = env("OLLAMA_MODEL", default="llama3.2")
OLLAMA_TIMEOUT = env.int("OLLAMA_TIMEOUT", default=180)
OLLAMA_EMBED_MODEL = env("OLLAMA_EMBED_MODEL", default="nomic-embed-text")

# Helpdesk RAG (Chroma)
HELPDESK_RAG_PERSIST_DIR = env(
    "HELPDESK_RAG_PERSIST_DIR", default=str(BASE_DIR / ".chroma_helpdesk")
)
HELPDESK_RAG_COLLECTION = env("HELPDESK_RAG_COLLECTION", default="helpdesk_faq")
